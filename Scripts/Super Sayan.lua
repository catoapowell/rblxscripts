...
z.SoundId = "rbxassetid://204277061"--303570180
z.Looped = true
z.Pitch = 1
z.Volume = 1
wait(.1)
...
--------------------------------------------
sm = Instance.new('SpecialMesh',char.Genkadda.Thingy)
sm2 = Instance.new('SpecialMesh',char.Genkadda.Handle)
sm.MeshId="http://www.roblox.com/asset/?id=0"
sm2.MeshId="http://www.roblox.com/asset/?id=0"
----------------------------------------------------
--[[function Vanish()
	for i = 1, 10 do wait()
...
fxm.MeshType = "Sphere"
--fxm.MeshType = "Cylinder"
fxm.MeshType = "FileMesh"
fxm.MeshId="http://www.roblox.com/asset/?id=9982590"
fxm.Scale = Vector3.new(1,1,1)
for i = 1, 20 do rs:wait()
        fx.Transparency = fx.Transparency - (1/20)
        fx.CFrame = torso.CFrame
        fxm.Scale = fxm.Scale + Vector3.new(0.5,0.5,0.5)
--fx.Size = fx.Size + Vector3.new(0.5,0.5,0.5)
        rs:wait()
end
----------------------------------------------------
local m = Instance.new("Model")
...
m:MakeJoints()
----------------------------------------------------
local cor2 = Instance.new("Part", char.Hair)
cor2.Name = "Link"
cor2.Locked = true
cor2.BottomSurface = 0
cor2.CanCollide = false
cor2.Size = Vector3.new(1, 9, 1)
cor2.Transparency = 1
cor2.TopSurface = 0
cor2w = Instance.new("Weld", cor2)
cor2w.Part0 = hed
cor2w.Part1 = cor2
cor2w.C0 = CFrame.new(0, 0, 0) * CFrame.Angles(math.rad(0), math.rad(0), math.rad(0))
cor2w.C1 = CFrame.new(0, 0, 0) * CFrame.Angles(math.rad(0), math.rad(0), math.rad(0))
...
if (torso.Velocity*Vector3.new(1, 1, 1)).magnitude > 1 then
    for i = 1, 20 do
        ...
        torso.Weld.C0 = Lerp(torso.Weld.C0, CFrame.new(0, -1.3, 0) * CFrame.Angles(math.rad(0), math.rad(0), math.rad(0)), 0.3)
        larm.Weld.C0 = Lerp(larm.Weld.C0, CFrame.new(-1.5, .3, -.5) * CFrame.Angles(math.rad(90), math.rad(0), math.rad(40)), 0.3)
        rarm.Weld.C0 = Lerp(rarm.Weld.C0, CFrame.new(1.5, .3, -.5) * CFrame.Angles(math.rad(90), math.rad(0), math.rad(-40)), 0.3)
        lleg.Weld.C0 = Lerp(lleg.Weld.C0, CFrame.new(-.5, -.8, -.5) * CFrame.Angles(math.rad(-20), math.rad(0), math.rad(0)), 0.2)
        rleg.Weld.C0 = Lerp(rleg.Weld.C0, CFrame.new(.5, -.8, -.5) * CFrame.Angles(math.rad(-20), math.rad(0), math.rad(0)), 0.2)
		...
		if Debounces.CanAttack == true then
            ...
            Debounces.NoIdl = true
				for i = 1, 15 do
					...
					larm.Weld.C0 = Lerp(larm.Weld.C0, CFrame.new(-1.5,.6,0)*CFrame.Angles(math.rad(0),math.rad(180),math.rad(-180)), 0.6)
...
--[[Partical2 = Instance.new("ParticleEmitter")
Partical2.Parent = larm
Partical2.Color = ColorSequence.new(Color3.new(0, 0, 0),Color3.new(0, 0, 0))
Partical2.Texture = "rbxasset://textures/particles/explosion01_implosion_main.dds"
Partical2.Speed = NumberRange.new(0,0)
Partical2.Rate = 1500
Partical2.Lifetime = NumberRange.new(0.5)
Partical3 = Instance.new("ParticleEmitter")
Partical3.Parent = larm
Partical3.Color = ColorSequence.new(Color3.new(0, 0, 0),Color3.new(0, 0, 0))
Partical3.Texture = "rbxasset://textures/particles/explosion01_implosion_main.dds"
Partical3.Speed = NumberRange.new(0,0)
Partical3.Rate = 1500
Partical3.Lifetime = NumberRange.new(0.5)
Partical4 = Instance.new("ParticleEmitter")
Partical4.Parent = larm
Partical4.Color = ColorSequence.new(Color3.new(0, 0, 0),Color3.new(0, 0, 0))
Partical4.Texture = "rbxasset://textures/particles/explosion01_implosion_main.dds"
Partical4.Speed = NumberRange.new(0,0)
Partical4.Rate = 1500
Partical4.Lifetime = NumberRange.new(0.5) ]]
wait(3)
				for i = 1, 15 do
					rarm.Weld.C0 = Lerp(rarm.Weld.C0, CFrame.new(1.5,.6,0)*CFrame.Angles(math.rad(0),math.rad(0),math.rad(30)), 0.2)
